...
<div class="carousel-item active">
 <img src="../img/banner/1.jpg" alt="Điện thoại thông minh" width="1100" height="500">
 <div class="carousel-caption">
   <h3>OPP0</h3>
   <p>Ðiện thoại thông minh</p>
 </div>
</div>
<div class="carousel-item">
  <img src="../img/banner/2.jpg" alt="Điện thoại thông minh" width="1100" height="500">
  <div class="carousel-caption">
    <h3>SAMSUNG</h3>
    <p>Ðiện thoại thông minh</p>
  </div>
...
<ul class="navbar-nav">
 <li class="nav-item active">
    <a class="nav-link" href="?controller=trangchu"><b>Trang chủ</b></a>
  </li>
 <li class="nav-item">
    <a class="nav-link" href="#"><b>Sản phẩm</b></a>
  </li>
 <li class="nav-item">
    <a class="nav-link" href="#"><b>Giới thiệu</b></a>
  </li>
 <li class="nav-item">
...
<div class="container">
  <!-- Body -->
  <div class="row mt-5">
    <h2 class="text-center col-md-12">Hiến thị sản phẩm</h2>
  </div>
  <!-- Phần hiễn thị sản phẩm-->
  <div class="row">
